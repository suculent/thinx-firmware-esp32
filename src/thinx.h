...
const char * THINX_APP_VERSION = "thinx-lib-esp32-arduino:2.1.170:2018-03-19";
const char * THINX_CLOUD_URL = "thinx.cloud";
const char * THINX_COMMIT_ID = "0";
const char * THINX_FIRMWARE_VERSION = "thinx-lib-esp32-arduino:2.1.170";
const char * THINX_FIRMWARE_VERSION_SHORT = "2.1.170";
