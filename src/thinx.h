...
const char * THINX_APP_VERSION = "thinx-lib-esp32-arduino:2.2.175:2018-04-16";
const char * THINX_CLOUD_URL = "thinx.cloud";
const char * THINX_COMMIT_ID = "0";
const char * THINX_FIRMWARE_VERSION = "thinx-lib-esp32-arduino:2.2.175";
const char * THINX_FIRMWARE_VERSION_SHORT = "2.2.175";
