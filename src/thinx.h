...
const char * THINX_APP_VERSION = "thinx-lib-esp8266-arduino:2.8.243:2020-01-11";
const char * THINX_CLOUD_URL = "thinx.cloud";
const char * THINX_COMMIT_ID = "0";
const char * THINX_FIRMWARE_VERSION = "thinx-lib-esp8266-arduino:2.8.243";
const char * THINX_FIRMWARE_VERSION_SHORT = "2.8.243";
